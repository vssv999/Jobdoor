...
import { Button, Navbar, Container, Nav, Row, Card } from "react-bootstrap";
  ...
  return (
    <Container fluid className="m-0 p-0">
      <RecruiterNavbar />
      {
        data && (
          <center>
            <Container className="container bg-white mb-5">
              <br></br>
              <div className="circle">
                <img src={elon} alt="Image" className="img-fluid"></img>
                <ul className="social">
              ...
              <div className="roundedd">
                <div className="col-md-6 border-right">
                  <div className="p-3 py-5">
                    ...
                    <div className="card col-md-12">
                      <div className="card-body p-2 tl">{data.email}</div>
                    </div>
              ...
              <Link to={"/updateProfile1"}>
                <Button type="button" className="mb-5" variant="dark">
                  Update
                </Button>
              </Link>
            </Container>
...
export default RecruiterProfile;
                  ...
                  //   <div className="card col-md-12">
                  //     <div className="card-body p-2">{data.username}</div>
                  //   </div>

                    
                  // </div>
                  // <div>
                  //   <h6 className="mt-2">Mobile No.</h6>
                  //   <div className="card col-md-12">
                  //     <div className="card-body p-2">{data.mobile}</div>
                  //   </div>
                  // </div>
                  // <div>
                  //   <h6 className="mt-2">Email</h6>
                  //   <div class="card col-md-12">
                  //     <div class="card-body p-2">{data.email}</div>
                  //   </div>
                  // </div>